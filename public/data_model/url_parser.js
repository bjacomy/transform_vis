...
/**
 * This class processes all Transform spec customizations,
...
export class UrlParser {
  ...
  parseUrl(obj, urlObj) {
    ...
    if (!url) {
      throw new Error(
        i18n.translate('visTypeTransform.urlParser.dataUrlRequiresUrlParameterInFormErrorMessage', {
    ...
    if (!query) {
      this._onWarning(
        i18n.translate('visTypeTransform.urlParser.urlShouldHaveQuerySubObjectWarningMessage', {
