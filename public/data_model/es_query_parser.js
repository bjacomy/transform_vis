...
export class EsQueryParser {
  ...
  parseUrl(dataObject, url) {
    ...
    if (body === undefined) {
      ...
      throw new Error(
        i18n.translate('visTypeTransform.esQueryParser.urlBodyValueTypeErrorMessage', {
    ...
    if (legacyContext !== undefined) {
      if (body.query !== undefined) {
        throw new Error(
          i18n.translate(
            'visTypeTransform.esQueryParser.dataUrlMustNotHaveLegacyAndBodyQueryValuesAtTheSameTimeErrorMessage',
            {
              defaultMessage:
        ...
        throw new Error(
          i18n.translate(
            'visTypeTransform.esQueryParser.dataUrlMustNotHaveLegacyContextTogetherWithContextOrTimefieldErrorMessage',
            {
              defaultMessage:
        ...
        throw new Error(
          i18n.translate('visTypeTransform.esQueryParser.legacyContextCanBeTrueErrorMessage', {
            defaultMessage:
      ...
      this._onWarning(
        i18n.translate('visTypeTransform.esQueryParser.legacyUrlShouldChangeToWarningMessage', {
    ...
    if (body.query !== undefined) {
      if (usesContext) {
        throw new Error(
          i18n.translate(
            'visTypeTransform.esQueryParser.urlContextAndUrlTimefieldMustNotBeUsedErrorMessage',
            {
              defaultMessage:
        ...
        for (const prop of Object.keys(obj)) {
          ...
          if (prop === 'interval' && subObj[AUTOINTERVAL]) {
            ...
            if (size === true) {
              ...
              throw new Error(
                i18n.translate('visTypeTransform.esQueryParser.autointervalValueTypeErrorMessage', {
          ...
          switch (subObj[TIMEFILTER]) {
            ...
            default:
              throw new Error(
                i18n.translate('visTypeTransform.esQueryParser.timefilterValueErrorMessage', {
                  defaultMessage:
  ...
  _getTimeBound(opts, type) {
    ...
    if (opts.shift) {
      ...
      if (typeof shift !== 'number') {
        throw new Error(
          i18n.translate('visTypeTransform.esQueryParser.shiftMustValueTypeErrorMessage', {
      ...
      switch (opts.unit || 'd') {
        ...
        default:
          throw new Error(
            i18n.translate('visTypeTransform.esQueryParser.unknownUnitValueErrorMessage', {
